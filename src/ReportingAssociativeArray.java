...
/**
 * An extension of the AssociativeArray class that reports each step it takes.
 *
...
public class ReportingAssociativeArray<K, V> extends AssociativeArray<K, V> {
  ...
  /**
   * Create a new ReportingAssociativeArray named `name` that prints reports of all actions using
   * `pen`.
   */
