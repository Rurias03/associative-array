...
public class AssociativeArrayExperiments {
  ...
  /**
   * Our first experiment: Associative arrays with strings as both keys and values.
   */
  ...
  /**
   * Our second experiment: Associative arrays with big integers as keys and values.
   */
